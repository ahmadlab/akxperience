...
function CheckAuthentication()
{
	...
	//session_start();
        //if (isset($_SESSION['ddiwebcmssession'])) {
        //    return true;
        //} else {
        //    return false;
        //}
	
	// if (isset($_SESSION['MICROSITE_SESS']) || isset($_SESSION['ADM_SESS'])) {
            // return true;
        // } else {
            // return false;
        // }
...
$config['LicenseName'] = 'DEPTECH DIGITAL INDONESIA, PT.';
...
$baseUrl = '/ford/uploads/ck_uploads/';
// $baseUrl = 'http://localhost/kalog/assets/libs/ckfinder/userfiles/';

//if (isset($_SESSION['MICROSITE_SESS']) && !isset($_SESSION['ADM_SESS'])){
//    $personal_folder=$_SESSION['MICROSITE_SESS']['microadmin_id_auth_user'];
//    $baseUrl = '/uploads/ck_uploads/'.$personal_folder.'/';
//}elseif (!isset($_SESSION['MICROSITE_SESS']) && isset($_SESSION['ADM_SESS'])){
//    $personal_folder=$_SESSION['ADM_SESS']['admin_id_auth_user'];
//    $baseUrl = '/uploads/ck_uploads/'.$personal_folder.'/';
//}
